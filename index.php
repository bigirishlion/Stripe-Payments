...
<div class="row">
      ...
      <div class="col-xs-3 ">
        <div class="row">
          <div class="col-sm-12">
            <button class="btn btn-default btn-block" data-toggle="modal" data-target="#stripeModal" data-is-donate="false" data-list-id="2df369cff0" data-cafe-member="Abby Morse">Subscribe</button>
          </div>
          <!-- <div class="col-sm-6">
